...
public class FleshGuyAnimations {
	public static final AnimationDefinition walk = AnimationDefinition.Builder.withLength(0.5F).looping()
			.addAnimation("body", new AnimationChannel(AnimationChannel.Targets.ROTATION,
					...
					new Keyframe(0.0833F, KeyframeAnimations.degreeVec(-2.1983F, 0.0576F, 1.4989F), AnimationChannel.Interpolations.CATMULLROM),
					new Keyframe(0.125F, KeyframeAnimations.degreeVec(-2.1256F, 0.0122F, 0.174F), AnimationChannel.Interpolations.CATMULLROM),
					new Keyframe(0.3333F, KeyframeAnimations.degreeVec(-1.8019F, -0.0358F, -1.7581F), AnimationChannel.Interpolations.CATMULLROM),
					new Keyframe(0.375F, KeyframeAnimations.degreeVec(-1.9283F, 0.0004F, -0.5725F), AnimationChannel.Interpolations.CATMULLROM),
			...
			.addAnimation("lleg", new AnimationChannel(AnimationChannel.Targets.ROTATION,
					...
					new Keyframe(0.3333F, KeyframeAnimations.degreeVec(10.83F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
			...
			.addAnimation("lleg", new AnimationChannel(AnimationChannel.Targets.POSITION,
					new Keyframe(0.0F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
					new Keyframe(0.0833F, KeyframeAnimations.posVec(0.0F, 0.8F, -2.5F), AnimationChannel.Interpolations.CATMULLROM),
			...
			.addAnimation("rleg", new AnimationChannel(AnimationChannel.Targets.ROTATION,
					new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
					new Keyframe(0.0833F, KeyframeAnimations.degreeVec(11.72F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
			...
			.addAnimation("rleg", new AnimationChannel(AnimationChannel.Targets.POSITION,
					...
					new Keyframe(0.3333F, KeyframeAnimations.posVec(0.0F, 0.8F, -2.5F), AnimationChannel.Interpolations.CATMULLROM),
	...
	public static final AnimationDefinition walk_close = AnimationDefinition.Builder.withLength(0.5F).looping()
			.addAnimation("body", new AnimationChannel(AnimationChannel.Targets.ROTATION,
					new Keyframe(0.0F, KeyframeAnimations.degreeVec(-2.5F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
					new Keyframe(0.0833F, KeyframeAnimations.degreeVec(-2.1983F, 0.0576F, 1.4989F), AnimationChannel.Interpolations.CATMULLROM),
					new Keyframe(0.125F, KeyframeAnimations.degreeVec(-2.1256F, 0.0122F, 0.174F), AnimationChannel.Interpolations.CATMULLROM),
			...
			.addAnimation("larm", new AnimationChannel(AnimationChannel.Targets.ROTATION,
					new Keyframe(0.0F, KeyframeAnimations.degreeVec(-75.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
					new Keyframe(0.125F, KeyframeAnimations.degreeVec(-82.5F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
					new Keyframe(0.25F, KeyframeAnimations.degreeVec(-75.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
